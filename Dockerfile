...
LABEL maintainer="hi@beevelop.com" \
      ...
      org.label-schema.description="Base Image for all of Beevelop's images – base on Ubuntu 18.04." \
      ...
      org.opencontainers.image.description="Base Image for all of Beevelop's images – base on Ubuntu 18.04." \
