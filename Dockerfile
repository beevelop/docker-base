...
LABEL maintainer="hi@beevelop.com" \
      ...
      org.label-schema.description="Base Image for all of Beevelop's images - based on Ubuntu 26.04 LTS." \
      ...
      org.opencontainers.image.description="Base Image for all of Beevelop's images - based on Ubuntu 26.04 LTS." \
